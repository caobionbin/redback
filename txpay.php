<?php
  if(!empty($cfg['mchid'])){
	...
	try {
		...
		pdo_insert('yihe_jifenbao_tixianlog',array("uniacid"=>$_W["uniacid"],"dwnick"=>$member['nickname'],"dopenid"=>$_W['fans']['from_user'],"dtime"=>time(),"dcredit"=>$dhPay,"dtotal_amount"=>$dhPay,"dmch_billno"=>$mch_billno,"dissuccess"=>$dissuccess,"dresult"=>$dresult));        
